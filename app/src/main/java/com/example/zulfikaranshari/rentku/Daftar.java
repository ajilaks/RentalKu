...
public class Daftar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuth = FirebaseAuth.getInstance();//inisiasi auth
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("user");//inisiasi database ref
